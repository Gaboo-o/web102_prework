...
const totalContributions = GAMES_JSON.reduce((total, cur) => total + cur.backers, 0);
...
const totalRaised = GAMES_JSON.reduce((total, cur) => total + cur.pledged, 0);
...
const descriptionStr = `A total of $${totalRaised.toLocaleString("en-US")} has been raised 
                    for ${GAMES_JSON.length} ${(GAMES_JSON.length > 1) ? "games" : "game"}. 
                    Currently, ${totalUnfundedGames} ${(totalUnfundedGames > 1) ? "games" : "game"} 
                    remains unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElem = document.createElement("p");
descriptionElem.innerHTML = descriptionStr;
